...
Modis_rrs_531 = r'D:\image\A20181212018151.L3m_MO_RRS_Rrs_531_4km.nc'
...
input5 = Rrs547.flatten()[:, np.newaxis]
input6 = Rrs667.flatten()[:, np.newaxis]
...
model = load_model(model_dir + 'model_Yorg6.h5', custom_objects={'r2_keras': r2_keras})
...
f_w = nc.Dataset('Y_distribution_py_RM_org_6b_mar.nc', 'w', format='NETCDF4')
